...
submit.addEventListener('click', () => {
  ...
  if (padresv == null && nivelv != null && amplitudv != null && hijosv != null && nodosv != null) {
    ...
    console.log("Sin amplitud", (padresv - nivelv + 1) * 2)
    if (nivelv > padresv + 1) {
    ...
    console.log("Crear arbol binario")
  }
  else if (nodos != null && hijosv != null && nivelv != null && amplitudv != null && padresv != null) {
    if (nodosv > ((nivelv - 1) * amplitudv) + 1) {
...
busqueda.addEventListener('click', () => {
  ...
  if (cadena == null)
    ...
    escribirbusq.textContent = 'Busqueda finalizada';
    ...
    if (cadena.length == 0) {
      ...
      escribirbusq.textContent = escribirbusq.textContent + 'Nodo encontrado por ' + bus;
...
function generarArbol(nivel, amplitud, padres, hijos, nodos) {
  ...
  if (nivel == null && amplitud == null && padres == null) {
    ...
    console.log(faltantesn, nodos, cont, cont2)
    while (faltantesn > 0) {
